...
return [
    ...
    'title' => 'ZapClass API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API oficial do ZapClass para integração com WhatsApp.',
    ...
    'auth' => [
        ...
        'placeholder' => 'zt_your_api_token_here',

        // Any extra authentication-related info for your users. Markdown and HTML are supported.
        'extra_info' => 'Você pode obter seu token de API acessando seu painel do ZapClass e clicando em <b>Gerar Token de API</b>. O token deve começar com "zt_".',
    ],
